...
class RoadNode:
    ...
    def to_dict(self):
        return {
            ...
            "is_task_anchor": bool(self.is_task_anchor),
...
class RoadNetwork:
    ...
    def add_node(self, nid, x, y, ntype=NodeType.NODE, name="", is_task_anchor=False):
        self.nodes[nid] = RoadNode(
            id=nid, x=x, y=y, node_type=ntype, port_name=name,
            is_task_anchor=is_task_anchor)
    ...
    def from_dict(cls, data):
        ...
        for nd in data["nodes"]:
            ...
            elif nd.get("is_task_anchor"): nt = NodeType.TASK_ANCHOR
            net.add_node(nd["id"], nd["x"], nd["y"], nt,
                         nd.get("port_name", ""), nd.get("is_task_anchor", False))
...
def load_road_network(json_path: str, ports_config: str = None) -> RoadNetwork:
    ...
    for n in data["nodes"]:
        ...
        if n.get("is_port"):
            n["port_name"] = port_names.get(n.get("source_id"), n.get("port_name", ""))
        if n.get("is_gas_station"):
            n["port_name"] = gas_names.get(n.get("source_id"), n.get("port_name", ""))
